...
static void create_fighter(vec2 pos)
{
    ...
    vector<Gun> guns;
    guns.emplace_back(i64(0), vec2(0.f, 32.f));
...
static void create_gunship(vec2 pos)
{
    ...
    vector<Gun> guns;
    guns.emplace_back(i64(0), vec2(0.f, 0.f));
    reg.emplace<CGuns>(ent, guns);
}
...
void create_enemy_spawner()
{
    ...
    reg.emplace<CSpawnEnemyDelay>(ent, ns_per_s * 1);
}
