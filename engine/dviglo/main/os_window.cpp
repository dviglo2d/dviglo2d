...
OsWindow::OsWindow()
{
    ...
    SdlPropsId props;
    props.set_string(SDL_PROP_WINDOW_CREATE_TITLE_STRING, engine_params::window_title.c_str());
    ...
    props.set_number(SDL_PROP_WINDOW_CREATE_WIDTH_NUMBER, engine_params::window_size.x);
    props.set_number(SDL_PROP_WINDOW_CREATE_HEIGHT_NUMBER, engine_params::window_size.y);
