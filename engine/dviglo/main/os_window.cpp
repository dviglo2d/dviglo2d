...
bool OsWindow::vk_create_instance()
{
    ...
    if (contains(vk_instance_extensions_, "VK_LAYER_KHRONOS_validation"))
...
OsWindow::OsWindow(const ConfigBase& config)
{
    ...
    #if 0
        // Проверка вывода ошибок в лог
        vk::DebugUtilsMessengerCallbackDataEXT callback_data { .pMessage = "!!!!!!!!!!!!!!!!!!" };

        vk_instance_->submitDebugUtilsMessageEXT(vk::DebugUtilsMessageSeverityFlagBitsEXT::eError,
