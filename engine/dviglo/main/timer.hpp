...
inline constexpr i64 ns_per_us = 1000;       // Наносекунд в микросекунде

constexpr i64 s_to_ns(i64 s)  { return s * ns_per_s; }
constexpr i64 ns_to_s(i64 ns) { return ns / ns_per_s; }

constexpr i64 ms_to_ns(i64 ms) { return ms * ns_per_ms; }
constexpr i64 ns_to_ms(i64 ns) { return ns / ns_per_ms; }

constexpr i64 us_to_ns(i64 us) { return us * ns_per_us; }
constexpr i64 ns_to_us(i64 ns) { return ns / ns_per_us; }
