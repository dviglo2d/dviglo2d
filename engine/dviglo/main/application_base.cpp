...
void ApplicationBase::handle_sdl_event(const SDL_Event& event)
{
    switch (event.type)
    {
    case SDL_EVENT_QUIT:
...
SDL_AppResult ApplicationBase::main_init()
{
    setup();
...
SDL_AppResult ApplicationBase::main_event(const SDL_Event* event)
{
...
SDL_AppResult ApplicationBase::main_iterate()
{
#ifdef DV_CTEST
