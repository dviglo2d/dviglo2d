...
#include "../vulkan/texture_set.hpp"
...
/*        if (!sprite_batch)
        ...
        const VulkanImage& iii = DV_TEXTURE_SET->get(base_path / "15_puzzle_data/textures/spritesheet.png", vk::Format::eR8G8B8A8Srgb);
...
// (исправлено на твой стиль доступа к device)
       ...
       // DV_GRAPHICS->vk_device_->resetFences(1, &(*in_flight_fence_));
        ...
        sprite_batch->DrawSprite({ 50.f, 50.f }, { 200.f, 200.f }, { 0.f, 0.f, 1.f, 1.f }, 0xFFFFFFFF, 0); // Красный квадрат

        // 2. Рисуем зеленый треугольник ПОВЕРХ квадрата
        //sprite_batch->DrawTriangle({ 300.f, 100.f }, { 400.f, 300.f }, { 200.f, 300.f }, 0xFF00FF00, 0);
        //sprite_batch->DrawTriangle({ 300.f, 100.f }, { 400.f, 300.f }, { 200.f, 300.f }, 0xFFFFFFFF, 0);

        // 3. Рисуем полупрозрачный синий квадрат
        //sprite_batch->DrawSprite({ 150.f, 150.f }, { 150.f, 150.f }, { 0.f, 0.f, 1.f, 1.f }, 0x88FF0000, 0);
        //sprite_batch->DrawSprite({ 150.f, 150.f }, { 150.f, 150.f }, { 0.f, 0.f, 1.f, 1.f }, 0x88FFFFFF, 0);
