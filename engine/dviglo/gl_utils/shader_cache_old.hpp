...
class ShaderCacheOld final : public SubsystemIndex
{
private:
    // Инициализируется в конструкторе
    inline static ShaderCacheOld* instance_ = nullptr;

    std::unordered_map<fs::path, ShaderProgram*> storage_;

public:
    static ShaderCacheOld* instance() { return instance_; }

    ShaderCacheOld();
    ~ShaderCacheOld() final;
...
#define DV_SHADER_CACHE_OLD (dviglo::ShaderCacheOld::instance())
