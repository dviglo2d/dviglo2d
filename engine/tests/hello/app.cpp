...
App::App()
{
    ...
    ShaderProgram* inverse_filter = DV_SHADER_CACHE_OLD->get(base_path / "engine_data/shaders/texture_shader.vert", base_path / "engine_test_data/shaders/inverse.frag");
