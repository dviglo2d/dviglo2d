...
* На левой боковой панели выбрать вкладку `Extensions`
* Нажать на шестерёнку рядом с `CMake Tools` и выбрать `Etension Settings`
* Найти `Cmake: Build Directory` и заменить `${workspaceFolder}/build` на `${workspaceFolder}/../build`
